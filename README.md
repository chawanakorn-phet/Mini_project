...
จัดกลุ่มตาม 5 ด้านทางธุรกิจ ทุกข้อตอบได้จริงจากตาราง `dim_*`/`fact_*` ที่ออกแบบไว้ในหัวข้อ 3

**การเติบโตและยอดขาย (Sales & Revenue Growth)**
1. ช่วงวันและเวลาใดที่มียอดสั่งซื้อสูงสุด และแนวโน้มรายได้รวมรายเดือน (MoM Growth) ของแพลตฟอร์มเติบโตขึ้นหรือลดลงอย่างไร?
2. รูปแบบการชำระเงินประเภทใด (บัตรเครดิต, Boleto, บัตรของขวัญ) ที่ดันให้ค่าเฉลี่ยต่อคำสั่งซื้อ (AOV) สูงที่สุด?
3. การผ่อนชำระหลายงวด (Installments) ช่วยเพิ่มยอดซื้อรวมต่อออเดอร์ได้จริงไหม หรือส่งผลให้อัตราการยกเลิกสินค้าสูงขึ้น?
...
5. ลูกค้าส่วนใหญ่อยู่ในรัฐหรือเมืองไหนกันแน่ และพื้นที่ใดคือ "ตลาดใหม่" ที่มียอดเติบโตของลูกค้าใหม่เร็วที่สุด?
6. ระยะทางระหว่างตำแหน่งผู้ขายและผู้ซื้อส่งผลต่อคะแนนรีวิวของลูกค้าหรือไม่?
...
10. หมวดหมู่สินค้าใดทำรายได้สูงสุด เทียบกับหมวดหมู่ที่ได้คะแนนรีวิวเฉลี่ยต่ำที่สุด?
11. องค์ประกอบหน้าสินค้า เช่น จำนวนรูปภาพ ความยาวชื่อ หรือความยาวคำบรรยาย ส่งผลต่อยอดขายและคะแนนรีวิวหรือไม่?
12. สินค้าชนิดใดที่มักถูกสั่งซื้อร่วมกันบ่อยๆ (Market Basket Analysis) เพื่อนำไปจัดชุดโปรโมชัน Cross-selling?

**การคัดกรองและบริหารผู้ขาย (Seller Operations & Quality Control)**
13. ยอดขายรวมของแพลตฟอร์มกระจุกตัวอยู่กับผู้ขายกลุ่ม Top 10% ตามกฎ Pareto (80/20) หรือไม่?
14. ความเร็วในการเตรียมสินค้าและส่งมอบให้ขนส่ง (Fulfillment Speed) ของผู้ขายส่งผลต่อคะแนนรีวิวร้านค้าอย่างไร?
15. ร้านค้าที่มีคะแนนรีวิวต่ำกว่าเกณฑ์มีพฤติกรรมอะไรร่วมกัน (เช่น ส่งช้า, อัตราการยกเลิกสูง) เพื่อให้แพลตฟอร์มสร้างระบบแจ้งเตือนได้ทันที?

> หมายเหตุ: ข้อ 15 ตัด "สินค้าชำรุด" ออกจากเกณฑ์ เพราะ Olist dataset ไม่มีข้อมูลสภาพสินค้า/การคืนสินค้าอยู่เลย ใช้แค่ delivery lateness และ cancellation rate แทน
